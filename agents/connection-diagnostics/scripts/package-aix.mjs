// Structural checker + safe local source zip for the connection-diagnostics agent.
//
...
// source zip you can inspect locally. It keeps the repo binary-free while still
// giving a local sanity check.
...
const out = join(outDir, 'connection-diagnostics-source.zip');
