// Structural checker + safe local source zip for the system-diagnostics agent.
//
...
if (!appJson.permissions || !appJson.permissions.includes('RECORD_AUDIO')) fail('RECORD_AUDIO permission missing');
if (!appJson.permissions || !appJson.permissions.includes('INTERNET')) fail('INTERNET permission missing');
